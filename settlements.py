...
def settlement_1(Player):
    ...
    while True :
        ...
        print(
            ...
            "| Healing potion:", Player.healing_potion,
            "| Mana potion:", Player.mana_potion,
...
def settlement_4(Player):
    ...
    while True :
        print("You stumble upon a port named 'The Sea's Biscuits'.")
        print(
            "Gold:", Player.gold,
            "| Health:", Player.health,
            "| Healing potion:", Player.healing_potion,
        ...
        if choice==("I"):
                ...
                if choice==("R"):
                    ...
                    if Player.doom_king_alive==False:
                        ...
                        if Player.main_quest==False:
                            ...
                            print("                                                              ")
                            print_settlement()
                            print("'It happens once in a blue moon, we get someone who has been resurrected for apparently no reason")
            ...
            while True: 
                ...
                print("Bone:",Player.demon_bone, "| Fur:", Player.ratling_fur, "| Tooth:",Player.imp_tooth,"| Silk:",Player.demon_silk,"| Iron:",Player.iron_shard,"| Brimstone:",Player.brimstone,"| Gold:",Player.gold)
                print("                                                                              ")
                print("Shadow Armour-25 PROT, 5x Demon Silk, 5x Ratling fur and 2000g              (S)")
